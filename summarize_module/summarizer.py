...
from utils.prompts import SUMMARIZE_INSTRUCTION, WEEKLY_SUMMARIZE_INSTRUCTION, SUMMARIZE_EXAMPLES, WEEKLY_SUMMARIZE_EXAMPLES, MONTHLY_SUMMARIZE_INSTRUCTION, MONTHLY_SUMMARIZE_EXAMPLES
